...
function Badge({ children, tone = "or" }) {
  const tones = {
    or: { bg: "linear-gradient(135deg, #FEF3C7, #FDE68A)", fg: "#92400E", ring: "#F59E0B" },
    vert: { bg: "linear-gradient(135deg, #CCFBF1, #99F6E4)", fg: "#0F766E", ring: "#14B8A6" },
    ardoise: { bg: "linear-gradient(135deg, #DBEAFE, #BFDBFE)", fg: "#1E3A8A", ring: "#3B82F6" },
  };
...
function Panel({ title, icon: Icon, actions, children }) {
  return (
    <div className="overflow-hidden rounded-2xl border shadow-md" style={{ borderColor: "#C7D2E5", background: "linear-gradient(180deg, #FFFFFF 0%, #F8FAFC 100%)" }}>
      <div className="flex items-center justify-between border-b px-5 py-3.5" style={{ borderColor: "#E2E8F0", background: "linear-gradient(90deg, #0B1F3A 0%, #1A3A6B 55%, #0F766E 100%)" }}>
        <div className="flex items-center gap-2">
          {Icon && <Icon size={17} style={{ color: "#FDE68A" }} />}
          <h3 className="font-serif text-[15px] font-semibold tracking-wide" style={{ color: "#F8FAFC" }}>{title}</h3>
        </div>
        {actions}
      </div>
...
function Stat({ label, value, tone }) {
  const tones = { ardoise: "#0B1F3A", or: "#B45309", vert: "#0F766E" };
  const bg = {
    ardoise: "linear-gradient(145deg, #FFFFFF 0%, #E0E7FF 100%)",
    or: "linear-gradient(145deg, #FFFBEB 0%, #FDE68A 100%)",
    vert: "linear-gradient(145deg, #F0FDFA 0%, #99F6E4 100%)",
  };
  return (
    <div className="rounded-2xl px-4 py-3.5 shadow-md border" style={{ background: bg[tone] || bg.ardoise, borderColor: "#CBD5E1" }}>
      <div className="text-[11px] font-bold uppercase tracking-widest" style={{ color: "#64748B" }}>{label}</div>
      <div className="mt-1 font-serif text-2xl font-bold" style={{ color: tones[tone] || "#0B1F3A" }}>{value}</div>
    </div>
  );
}
...
function Btn({ children, onClick, variant = "primary", icon: Icon, small }) {
  ...
  const styles = {
    primary: { background: "linear-gradient(135deg, #0B1F3A 0%, #1A3A6B 100%)", color: "#F8FAFC" },
    gold: { background: "linear-gradient(135deg, #F59E0B 0%, #D97706 100%)", color: "#1C1917" },
    ghost: { background: "rgba(255,255,255,0.85)", color: "#0B1F3A", boxShadow: "inset 0 0 0 1.5px #1A3A6B66" },
    danger: { background: "linear-gradient(135deg, #EF4444 0%, #B91C1C 100%)", color: "#FFFFFF" },
  };
  return (
...
function Connexion({ onEntrer, onInscription, eleves, rolesBloques = {} }) {
  ...
  return (
    <div className="min-h-screen w-full" style={{ background: "linear-gradient(160deg, #0B1F3A 0%, #1A3A6B 45%, #0F766E 100%)" }}>
...
function Coquille({ role, roleLabel, onQuitter, children, nav, actif, setActif }) {
  ...
  return (
    <div className="min-h-screen w-full" style={{ background: "linear-gradient(165deg, #EEF2FF 0%, #F8FAFC 40%, #ECFDF5 100%)" }}>
      <header className="sticky top-0 z-10 border-b backdrop-blur-md shadow-sm"
              style={{ borderColor: "#C7D2E5", background: "linear-gradient(90deg, rgba(11,31,58,0.97) 0%, rgba(26,58,107,0.95) 60%, rgba(15,118,110,0.92) 100%)" }}>
          ...
          {nav.map((n) => {
            ...
            return (
              <button
                ...
                style={{
                  background: isActif ? "linear-gradient(135deg, #0B1F3A, #0F766E)" : "rgba(255,255,255,0.8)",
            ...
            {nav.map((n) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: isActif ? "linear-gradient(135deg, #0B1F3A, #1A3A6B)" : "transparent",
                    color: isActif ? "#F8FAFC" : "#334155",
...
export default function EcoleConnecteeCSP() {
  ...
  if (SUPABASE_CONFIGURE && !basePrete) {
    return (
      <div className="flex min-h-screen w-full items-center justify-center px-6" style={{ background: "linear-gradient(165deg, #EEF2FF, #ECFDF5)" }}>
