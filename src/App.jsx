...
function Badge({ children, tone = "or" }) {
  const tones = {
    ...
    vert: { bg: "linear-gradient(135deg, #D1FAE5, #34D399)", fg: "#065F46", ring: "#059669" },
...
function Panel({ title, icon: Icon, actions, children }) {
  return (
    <div className="overflow-hidden rounded-2xl border shadow-md" style={{ borderColor: "#E8D5B5", background: "linear-gradient(180deg, #FFFDF9 0%, #FFFFFF 100%)" }}>
      <div className="flex items-center justify-between border-b px-5 py-3.5" style={{ borderColor: "#F0E0C8", background: "linear-gradient(90deg, #92400E 0%, #B45309 40%, #CA8A04 100%)" }}>
...
function Stat({ label, value, tone }) {
  const tones = { ardoise: "#9D174D", or: "#B45309", vert: "#047857" };
  const bg = {
    ardoise: "linear-gradient(145deg, #FDF2F8 0%, #FBCFE8 100%)",
    or: "linear-gradient(145deg, #FFFBEB 0%, #FCD34D 100%)",
    vert: "linear-gradient(145deg, #ECFDF5 0%, #6EE7B7 100%)",
  };
  return (
...
function Btn({ children, onClick, variant = "primary", icon: Icon, small }) {
  ...
  const styles = {
    primary: { background: "linear-gradient(135deg, #9D174D 0%, #BE185D 100%)", color: "#FFF1F2" },
    gold: { background: "linear-gradient(135deg, #F59E0B 0%, #D97706 100%)", color: "#1C1917" },
    ghost: { background: "rgba(255,255,255,0.9)", color: "#92400E", boxShadow: "inset 0 0 0 1.5px #D9770666" },
...
function Connexion({ onEntrer, onInscription, eleves, rolesBloques = {} }) {
  ...
  return (
    <div className="min-h-screen w-full" style={{ background: "linear-gradient(160deg, #78350F 0%, #B45309 40%, #047857 100%)" }}>
...
function Coquille({ role, roleLabel, onQuitter, children, nav, actif, setActif }) {
  ...
  return (
    <div className="min-h-screen w-full" style={{ background: "linear-gradient(165deg, #FFF7ED 0%, #FFFBEB 45%, #ECFDF5 100%)" }}>
      <header className="sticky top-0 z-10 border-b backdrop-blur-md shadow-sm"
              style={{ borderColor: "#C7D2E5", background: "linear-gradient(90deg, #78350F 0%, #B45309 50%, #047857 100%)" }}>
          ...
          {nav.map((n) => {
            ...
            return (
              <button
                ...
                style={{
                  background: isActif ? "linear-gradient(135deg, #B45309, #047857)" : "rgba(255,255,255,0.9)",
            ...
            {nav.map((n) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: isActif ? "linear-gradient(135deg, #B45309, #9D174D)" : "transparent",
                    color: isActif ? "#F8FAFC" : "#334155",
...
export default function EcoleConnecteeCSP() {
  ...
  if (SUPABASE_CONFIGURE && !basePrete) {
    return (
      <div className="flex min-h-screen w-full items-center justify-center px-6" style={{ background: "linear-gradient(165deg, #FFF7ED, #ECFDF5)" }}>
