    ...
    const tenterChargement = () => {
      ...
      chargerToutesLesDonnees()
        ...
        .catch((err) => {
          ...
          // Ne pas afficher l'écran démo : on réessaie jusqu'à succès
          if (essais < 8) {
            ...
            setErreurChargement(
              ...
              " — Impossible de joindre la base après plusieurs essais. Vérifiez VITE_SUPABASE_URL / VITE_SUPABASE_ANON_KEY sur Vercel, puis actualisez."
            );
          }
        });
    };
