              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="rounded-lg border p-3" style={{borderColor:"#F6C0C0", background:"#FBEAEA"}}>
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    <button onClick={()=>{ if(confirm("FONDATEUR: Supprimer TOUS les élèves ? Irréversible !")) { marquerElevesSupprimes((eleves||[]).map(e=>e.id)); setEleves([]); } }} className="rounded px-2 py-1 text-[12px] font-bold" style={{background:"#8A2E2E", color:"white"}}>Supprimer tous élèves</button>
