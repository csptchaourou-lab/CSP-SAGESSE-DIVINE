      ...
      {onglet === "classe" && (
        <Panel title={`Classe ${maClasse}`} icon={Users}>
          <div className="mb-4 flex flex-wrap items-center gap-2 rounded-lg px-3 py-2" style={{ background: "#F1ECDD" }}>
            <label className="text-[13px] font-medium" style={{ color: "#5C5240" }}>
              {classeAssignee ? "Ta classe (liée à ton code) :" : "Choisir une classe :"}
            </label>
            {classeAssignee ? (
              <span className="rounded-full px-3 py-1 text-[14px] font-bold" style={{ background: "#1B2A4A", color: "#C9A227" }}>{maClasse}</span>
            ) : (
