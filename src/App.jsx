...
const supprimerDemande = (demande) => {
  ...
  const cloturerAnnee = () => {
    ...
    if (typeof window !== "undefined") {
      try { window.__cspAnneeVierge = true; } catch (e) {}
    }
    setEleves([]);
    setMessagesParents([]);
    setDemandes([]);
...
export default function EcoleConnecteeCSP() {
  ...
  useEffect(() => {
    ...
    chargerToutesLesDonnees()
      .then((d) => {
        ...
        setEleves(d.eleves.length ? d.eleves : (SUPABASE_CONFIGURE ? [] : ELEVES_INIT));
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      ...
      avecSuivi(syncEleves(elevesRef.current || [], { vider }));
    }, sourceRemoteRef.current ? 1200 : 400);
