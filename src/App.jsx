...
function Connexion({ onEntrer, onInscription, eleves, rolesBloques = {} }) {
...
export default function EcoleConnecteeCSP() {
  ...
  if (!role) {
    return (
      <EcoleContext.Provider value={contexteEcole}>
        <Connexion onEntrer={entrer} onInscription={() => setVue("inscription")} eleves={eleves} rolesBloques={lireRolesBloques()} />
      </EcoleContext.Provider>
    );
  }
