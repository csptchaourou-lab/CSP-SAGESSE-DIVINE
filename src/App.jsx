...
function EspaceDirecteur({ eleves, personnel, setPersonnel, annonces, setAnnonces, demandes, setDemandes, setEleves }) {
  ...
  const sauvegarderDemande = (demande) => {
    ...
    // si validée, mettre à jour l'élève correspondant
    if(demande.statut==="validee"){
      setEleves((prev)=>prev.map((e)=> (e.nom===oldNom && e.prenom===oldPrenom && e.classe===oldClasse) ? { ...e, nom: editionForm.nom.trim(), prenom: editionForm.prenom.trim(), classe: editionForm.classeSouhaitee, naissance: editionForm.naissance, parent: { nom: editionForm.parrainNom, telephone: editionForm.parrainTelephone } } : e));
    }
  ...
  const supprimerDemande = (demande) => {
    ...
    // si validée, supprimer l'élève correspondant (cherché par nom/prenom/classe)
    if(demande.statut === "validee"){
